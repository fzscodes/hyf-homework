...
-- Meal
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Soup', 'Campbells-Classic Chix', '53 Kenwood Junction', '2020-05-19  18:49:10', 2, 17.34, '2020-05-15');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Muffin', 'Mix - Creme Brule 15l', '8208 Homewood Place', '	2020-05-27 01:39:10', 3, 20.75, '2020-05-25');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Bouillion', ' Fish', '71 Annamark Drive', '2020-05-24 11:08:33', 5, 42.67, '2020-05-23');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Bread' , 'Wheat Baguette', '4 Blaine Junction', '	2020-05-31 15:47:01', 10, 11.31, '2020-05-30');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Appetizer', 'Assorted Box', '2 Redwing Trail', '2020-05-29 03:55:20', 8, 8.14, '2020-05-26');
...
values
  ('Soup review', 'ok', 1, 4, '2020-05-22');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Muffin review', 'Very Good', 2, 5, '2020-06-01');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Bouillion review', 'Bad', 3, 1, '2020-06-02');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Bread review', 'Good', 4, 4, '2020-06-04');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Appetizer review', 'Ok', 5, 3, '2020-05-31');
...
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Halibut', 'Steaks', '3 Trailsway Junction', '2020-06-02 20:29:13', 6, '35.05', '2020-06-01');
...
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Halibut review', 'Good', 6, 4, '2020-06-03');
...
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Chinese Foods', 'Thick Noodles', '3 New Castle Plaza', '2020-03-25 01:55:16', 20, 120.27, '2020-03-15');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('White Baguette', 'Bread', '9 Grim Road', '2020-02-04 07:36:14', 10, 9.21, '2020-02-01');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Spring Roll Wrappers', 'Wraps', '1 Laurel Street', '2020-03-27 02:55:23', 5, 11.32, '2020-03-20');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Pecan Raisin - Tarts', 'Tarts', '149 Westridge Way', '2020-04-17 06:41:29', 7, 5.14, '2020-04-10');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Pasta', 'Lasagna Noodle', '78064 Sherman Drive', '2020-01-23 19:46:26', 12, 134.81, '2020-01-10');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Lamb', 'Whole Head Off', '75827 Warner Alley', '2020-04-27 13:55:57', 25, 152.38, '2020-04-15');
insert into Meal
  (title, description, location, meal_time, max_reservations, price, created_date)
values
  ('Bread-Pita', 'Pita', '51934 Melrose Street', '2020-03-09 15:05:49', 15, 4.71, '2020-03-02');
...
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Chinese Food review', 'Excellent', 7, 5, '2020-03-22');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Lamb review', 'Excellent', 12, 5, '2020-04-25');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Pasta', 'Good', 11, 4, '2020-01-24');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Spring Roll Wrapps review', 'Bad', 9, 1, '2020-03-28');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('White Baguette review', 'Ok', 8, 3, '2020-02-03');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Pecan Raisin review', 'Very Good', 10, 4, '2020-04-15');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Pita review', 'Good', 13, 4, '2020-03-15');
insert into Review
  (title, description, meal_id, stars,created_date)
values
  ('Chinese Food review', 'Good', 7, 4 , '2020-03-22');
